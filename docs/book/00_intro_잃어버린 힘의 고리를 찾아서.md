...
현대 물리학은 인류 지성사에서 가장 위대한 두 가지 성취 위에 서 있다. 하나는 거시 세계의 유려한 공간을 설명하는 아인슈타인의 **일반상대성이론(General Relativity)**이며, 다른 하나는 미시 세계의 확률적 입자를 다루는 **양자역학(Quantum Mechanics)**이다.
